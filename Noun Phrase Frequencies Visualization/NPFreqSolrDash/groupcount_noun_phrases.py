...
def create_monthly_grouped_df():
    ...
    # Unpickle data frame
    pickle_in = open('total_phrase_counter.pickle', "rb")
    ...
    grouped_df = df.groupby(pd.Grouper(freq='1M')).num_phrases.agg(['sum','count']).rename(columns={'sum': 'monthly_phrasefreq',
    ...
    grouped_df.T.to_json('phrases_and_docs_monthly.json', orient='records') 
