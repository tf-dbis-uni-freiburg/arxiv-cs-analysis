...
if __name__ == '__main__':
    ...
    docs_df = docs_df.groupby('wikipedia_url').sum()
    docs_df = docs_df.sort_values(by='num_occurrences', ascending=False)
    docs_df.to_csv('entity_mentions_descending.tsv', sep='\t')